...
class PyTorchFemnistAggregator(TopAggregator):
    ...
    def initialize(self):
        ...
        self.model = tormodels.__dict__["resnet101"](num_classes=62).to(device=self.device)
    ...
    def evaluate(self) -> None:
        ...
        logger.info(f"Wall-clock time: {self.current_round_time} ||"
                    ...
                    f"R#{self._round}'s duration (s): {self.current_round_time-self.previous_round_time:.2f}")
