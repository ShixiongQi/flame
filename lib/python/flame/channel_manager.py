...
class ChannelManager(object):
    ...
    #             print("channel doesn't have its own backend, notthing to do")
    #             continue
    ...
    #         print("every channel has its own backend\n no need to have a default backend")
    #         return
    ...
    def _setup_backends(self):
        ...
        print(f"distinct_backends: {distinct_backends}")
        print(f"self._backends[ch_name]: {self._backends}")
